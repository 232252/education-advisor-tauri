...
import { cn, riskColor } from '../../lib/ui-utils'
...
function AcademicsTab({ studentName, isDark }: { studentName: string; isDark: boolean }) {
  ...
  const comparison: StudentComparison | null = useMemo(() => {
    ...
    const conductDelta = conductEvents ? aggregateConductDelta(conductEvents, studentName) : null
              ...
              {comparison.subjects.filter((s) => s.scoreA !== null || s.scoreB !== null).length >
                ...
                <div className="mt-2">
                  <ReactEChartsCore
                    ...
                    option={{
                      tooltip: { trigger: 'axis' },
                      legend: { data: ['考试 A', '考试 B'], textStyle: { color: axisColor } },
